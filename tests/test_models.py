...
class TestBaseModel:
    def test_base_model(self):
        base = SegmentationModel(encoder_name="resnet50", encoder_weights="imagenet", num_classes=21)
...
class TestFCN:
    def test_resnet50_encoder(self, mocker):
        ...
        fcn = FCN(encoder_name="resnet50")

        mock_fcn_resnet50.assert_called_once_with(weights=FCN_ENCODERS["resnet50"], num_classes=21)
    ...
    def test_resnet101_encoder(self, mocker):
        ...
        fcn = FCN(encoder_name="resnet101")

        mock_fcn_resnet101.assert_called_once_with(weights=FCN_ENCODERS["resnet101"], num_classes=21)
    ...
    def test_invalid_encoder(self):
        with pytest.raises(ValueError, match='Encoder "invalid_encoder" is not supported for the FCN.'):
            model = FCN(encoder_name="invalid_encoder")
    ...
    def test_forward(self, mocker):
        ...
        model = FCN(encoder_name="resnet50")
...
class TestDeepLabV3:
    def test_resnet50_encoder(self, mocker):
        ...
        deeplabv3 = DeepLabV3(encoder_name="resnet50")

        mock_deeplabv3_resnet50.assert_called_once_with(weights=DEEPLABV3_ENCODERS["resnet50"], num_classes=21)
    ...
    def test_resnet101_encoder(self, mocker):
        ...
        deeplabv3 = DeepLabV3(encoder_name="resnet101")

        mock_deeplabv3_resnet101.assert_called_once_with(weights=DEEPLABV3_ENCODERS["resnet101"], num_classes=21)
    ...
    def test_mobilenetv3_encoder(self, mocker):
        ...
        deeplabv3 = DeepLabV3(encoder_name="mobilenet_v3_large")

        mock_deeplabv3_mobilenetv3.assert_called_once_with(
            weights=DEEPLABV3_ENCODERS["mobilenet_v3_large"], num_classes=21
        )
    ...
    def test_invalid_encoder(self):
        with pytest.raises(ValueError, match='Encoder "invalid_encoder" is not supported for the DeepLabV3.'):
            model = DeepLabV3(encoder_name="invalid_encoder")
